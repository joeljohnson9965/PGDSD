...
public class ImageController {
	...
	public String editImage(@RequestParam("imageId") Integer imageId, Model model, HttpSession session) {
		...
		User user = (User) session.getAttribute("loggeduser");
		/*
		 * Condition to check if the current user is same as the image uploaded user, if
		 * yes only then edit
		 */
	...
	// tags after converting the â€˜tagsâ€™ string to a list of all the tags and
	// also
